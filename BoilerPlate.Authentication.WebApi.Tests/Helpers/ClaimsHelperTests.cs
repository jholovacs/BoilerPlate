...
public class ClaimsHelperTests
{
    ...
    /// Scenario: A claims principal is created with a tenant_id claim containing a valid GUID. The helper method should extract and return the tenant ID.
    /// </summary>
    [Fact]
    ...
    /// Scenario: A claims principal is created with the Microsoft-standard tenant ID claim (http://schemas.microsoft.com/identity/claims/tenantid) containing a valid GUID. The helper method should extract and return the tenant ID.
    /// </summary>
    [Fact]
    ...
    /// Scenario: A claims principal contains both tenant_id and Microsoft tenant ID claims with different values. The helper method should return the value from tenant_id as it has higher priority.
    /// </summary>
    [Fact]
    ...
    /// Scenario: A claims principal is created without any tenant ID related claims. The helper method should return null to indicate the tenant ID is not available.
    /// </summary>
    [Fact]
    ...
    /// Scenario: A claims principal contains a tenant_id claim with a value that is not a valid GUID format. The helper method should return null as it cannot parse the invalid GUID.
    /// </summary>
    [Fact]
    ...
    /// Scenario: A claims principal contains a tenant_id claim with an empty string value. The helper method should return null as empty strings are not valid tenant IDs.
    /// </summary>
    [Fact]
    ...
    /// Scenario: A claims principal contains a tenant_id claim with only whitespace characters. The helper method should return null as whitespace is not a valid tenant ID.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Test case: GetUserId should return the user ID when a valid NameIdentifier claim is present in the claims principal.
    /// Scenario: A claims principal is created with a ClaimTypes.NameIdentifier claim containing a valid GUID. The helper method should extract and return the user ID.
    /// </summary>
    [Fact]
    ...
    /// Scenario: A claims principal is created with a sub claim (JWT standard subject claim) containing a valid GUID. The helper method should extract and return the user ID.
    /// </summary>
    [Fact]
    ...
    /// Scenario: A claims principal is created with a user_id claim containing a valid GUID. The helper method should extract and return the user ID as a fallback when standard claims are not available.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Test case: GetUserId should prefer NameIdentifier claim over sub and user_id claims when multiple claims are present.
    /// Scenario: A claims principal contains NameIdentifier, sub, and user_id claims with different values. The helper method should return the value from NameIdentifier as it has the highest priority.
    /// </summary>
    [Fact]
    ...
    /// Scenario: A claims principal contains sub and user_id claims with different values but no NameIdentifier claim. The helper method should return the value from sub as it has higher priority than user_id.
    /// </summary>
    [Fact]
    ...
    /// Scenario: A claims principal is created without any user ID related claims (NameIdentifier, sub, or user_id). The helper method should return null to indicate the user ID is not available.
    /// </summary>
    [Fact]
    ...
    /// Scenario: A claims principal contains a sub claim with a value that is not a valid GUID format. The helper method should return null as it cannot parse the invalid GUID.
    /// </summary>
    [Fact]
    ...
    /// Scenario: A claims principal contains a sub claim with an empty string value. The helper method should return null as empty strings are not valid user IDs.
    /// </summary>
    [Fact]
    ...
    /// Scenario: A claims principal contains a sub claim with only whitespace characters. The helper method should return null as whitespace is not a valid user ID.
    /// </summary>
    [Fact]
