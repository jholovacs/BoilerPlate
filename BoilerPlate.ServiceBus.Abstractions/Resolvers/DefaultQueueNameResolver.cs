...
/// <summary>
///     Default implementation of IQueueNameResolver
///     Resolves queue names from message type names using a configurable naming convention
/// </summary>
public class DefaultQueueNameResolver : IQueueNameResolver
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="DefaultQueueNameResolver" /> class
    ///     Uses a default naming strategy that converts type names to kebab-case
    /// </summary>
    public DefaultQueueNameResolver()
    ...
    public DefaultQueueNameResolver(Func<Type, string> namingStrategy)
    {
    ...
    {
        if (string.IsNullOrWhiteSpace(name)) return "default-queue";
        ...
        // Ensure not empty
        if (string.IsNullOrEmpty(sanitized)) sanitized = "default-queue";
    ...
    /// <returns>The queue name in kebab-case</returns>
    ...
    /// </summary>
    /// <param name="messageType">The message type</param>
    /// <returns>The queue name based on full type name</returns>
    ...
    /// </summary>
    /// <param name="messageType">The message type</param>
    /// <returns>The queue name as the type name</returns>
