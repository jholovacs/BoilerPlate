...
public abstract class BaseAuthDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, Guid>
{
    ...
    /// <summary>
    ///     Tenant email domains for mapping email domains to tenants
    /// </summary>
    public DbSet<TenantEmailDomain> TenantEmailDomains { get; set; } = null!;

    /// <summary>
    ///     Tenant vanity URLs for mapping vanity URLs (hostnames) to tenants
    /// </summary>
    public DbSet<TenantVanityUrl> TenantVanityUrls { get; set; } = null!;

    /// <summary>
    ///     MFA challenge tokens for temporary tokens during MFA verification
    /// </summary>
    public DbSet<MfaChallengeToken> MfaChallengeTokens { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        // Configure TenantEmailDomain
        builder.Entity<TenantEmailDomain>(entity =>
        {
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Id).ValueGeneratedNever(); // UUIDs are generated by application
            entity.Property(e => e.TenantId).IsRequired();
            ...
            // Unique constraint: Domain must be unique across all tenants
            entity.HasIndex(e => e.Domain)
                .IsUnique();

            // Index on tenant ID for fast lookup
            entity.HasIndex(e => e.TenantId);
            ...
            entity.HasOne(e => e.Tenant)
                .WithMany()
                .HasForeignKey(e => e.TenantId)
                .OnDelete(DeleteBehavior.Cascade); // Cascade delete domain mappings when tenant is deleted
        });

        // Configure TenantVanityUrl
        builder.Entity<TenantVanityUrl>(entity =>
        {
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Id).ValueGeneratedNever(); // UUIDs are generated by application
            entity.Property(e => e.TenantId).IsRequired();
            ...
            // Unique constraint: Hostname must be unique across all tenants
            ...
            entity.HasOne(e => e.Tenant)
                .WithMany()
                .HasForeignKey(e => e.TenantId)
                .OnDelete(DeleteBehavior.Cascade); // Cascade delete vanity URL mappings when tenant is deleted
        });

        // Configure MfaChallengeToken
        builder.Entity<MfaChallengeToken>(entity =>
        {
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Id).ValueGeneratedNever(); // UUIDs are generated by application
            entity.Property(e => e.UserId).IsRequired();
        ...
        builder.Entity<UserPasswordHistory>(entity =>
        {
            ...
            // Index on user ID and tenant for fast lookup
            entity.HasIndex(e => new { e.UserId, e.TenantId });

            // Index on changed date for cleanup queries
            entity.HasIndex(e => new { e.UserId, e.TenantId, e.ChangedAt });

            // Foreign key to ApplicationUser
            entity.HasOne(e => e.User)
                .WithMany()
                .HasForeignKey(e => e.UserId)
                .OnDelete(DeleteBehavior.Cascade); // Cascade delete history when user is deleted
